export const FAQS_LIST = [
    {
        ...
        answer: `${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"
    ...
    },
    {
        ...
        answer: `No, you do not need an agent to request offers with ${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"
            }.`,
    },
    {
    ...
    },
    {
        ...
        answer: `No. Requesting an offer from ${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"
            } is completely free.`,
    },
    {
        question: "Am I obligated to accept an offer?",
        answer: `No, you are not obligated to accept any ${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"
            } offer you receive.`,
    },
];
...
export const PROPERTIES_LIST = [
    {
        ...
        daysSold: 5,
        image:
            `${import.meta.env.VITE_HEROKU_ASSETS_BASE_PATH}images/property_image.webp`,
    },
    {
        id: 2,
        price: "$1,699,000",
...
export const CLIENTS_LIST = [
    {
        image:
            `${import.meta.env.VITE_HEROKU_ASSETS_BASE_PATH}images/client.jpg`,
        name: "Kevin L.",
    ...
    {
        image:
            `${import.meta.env.VITE_HEROKU_ASSETS_BASE_PATH}images/client-2.jpg`,
        name: "Traci M.",
        role: `${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"} Client`,
        quote: `${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"
            } helped match me with a cash buyer within days. The process was extremely easy and efficient. I would definitely recommend ${import.meta.env.VITE_BRAND_NAME || "Trusted Home Offers"
