...
export default function Steps() {
  ...
  return (
    <section className="max-w-600 mx-auto flex flex-col py-20 text-[#273653] px-4">
      {/* Heading */}
      <div className="text-center mb-16">
        ...
        <p className="text-lg mt-4 max-w-4xl mx-auto">
          ...
          get the best price and close fast.
        </p>
      </div>
      ...
      <div className="flex flex-col ">
        ...
        {steps.map((step, i) => (
          ...
          >
            ...
            {i !== 0 && (
              <div>
                ...
                >
                  <path
                    d="M1 0L1 64"
                    stroke="url(#paint0_linear_2767_13211)"
                    stroke-width="2"
                  ></path>
                  <defs>
                    <linearGradient
                      id="paint0_linear_2767_13211"
                      x1="1.5"
                      y1="-2.18557e-08"
                      x2="1.5"
                      y2="64"
                    ...
                    >
                      <stop stop-color="#46B6FF" stop-opacity="0"></stop>
                      <stop offset="1" stop-color="#46B6FF"></stop>
                    </linearGradient>
                  </defs>
                </svg>
              </div>
            ...
            <div
              className={`w-8 h-8 mb-5 mx-auto  flex items-center justify-center 
                                        border-2 rounded-full text-md font-bold transition-colors duration-300
                                        ${
                                          activeStep === i + 1
                                            ? "bg-[#46b6ff] border-[#46b6ff] text-white"
        ...
        >
          ...
          <div className="hidden md:flex justify-center mb-10 -mt-1">
            ...
            >
              <path
                d="M271 1C270.327 20.6972 252.125 60.0917 184.701 60.0917C100.421 60.0917 4.53272 55.2538 1.00001 100.868V114"
                stroke="#46B6FF"
                strokeWidth="2"
              />
            </svg>
          ...
          {/* VS */}
          <div className="flex gap-6 text-2xl md:text-4xl font-bold mb-10 md:mb-24 justify-center -ml-7 mt-2 md:mt-0 md:-ml-10">
            <span>Investors</span>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 justify-center items-center">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-400 w-full max-w-xl lg:max-w-[35rem] transform lg:-translate-y-10">
              ...
              <p className="mt-2 text-sm md:text-base">
                Investors can help you sell your home for a competitive price in
                as few as 10 days, with no additional fees, agent commission, or
                prep-work.
              </p>
            ...
            {/* Agents Card */}
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border h-[279px] lg:h-[336px] border-gray-400 w-full max-w-xl lg:max-w-[35rem] transform lg:-translate-y-10">
              <h3 className="text-xl md:text-2xl font-bold">Talk to agents</h3>
              <p className="mt-2 text-sm md:text-base">
                Agents can get you top dollar in your local market by listing
                your home.
              </p>
