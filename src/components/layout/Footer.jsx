                    ...
                    <div className="col-xs-12">
                        <ul className="last-details" style={{ margin: "0 !important" }}>
                            <li className="flex flex-wrap items-center justify-center gap-2">
                                ...
                                <span className="tos">
                                    <a 
                                        href="https://try.trustedhomeoffers.org/terms-of-use" 
                                    ...
                                    <a 
                                        href="https://try.trustedhomeoffers.org/privacy-policy" 
                                        className="hover:underline"
                                    >
                                        Privacy Policy
                                    </a>
                            ...
                            <li className="text-center">Do Not Sell or Share My Personal Information</li>
                        </ul>
                    </div>
                </div>
                <div className="row">
