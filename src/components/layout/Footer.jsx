...
export default function Footer() {
    return (
        <footer className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] border-t border-gray-300 pt-10 pb-14 flex flex-col text-center items-center text-gray-600">
            ...
            {/* Links */}
            <div className="flex flex-wrap justify-center text-xs mb-4 text-gray-700">
